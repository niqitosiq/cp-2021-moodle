...
(function () {
    ...
    const file$4 = "src/components/ui/Button.svelte";
    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1l6cj16");
    			add_location(img, file$2, 18, 1, 311);
    			attr_dev(div0, "id", "rect");
    			add_location(div0, file$2, 20, 1, 354);
    			attr_dev(div1, "class", "wrapper svelte-1l6cj16");
    			add_location(div1, file$2, 17, 0, 288);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		tl.to("#map", { x: -400, y: -200, duration: 5 }).to("#map", { x: 0, y: 0, duration: 5 });
    	});
    	...
    	$$self.$capture_state = () => ({ Dice, gsap: gsapWithCSS, onMount });
    	return [];
    }
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 31, 2, 654);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);

    ...
    */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "dice svelte-1y4lrv1");
    			add_location(div, file$2, 26, 2, 539);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:2) <Button on:click={rollDice}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1y4lrv1");
    			add_location(img, file$2, 35, 2, 702);
    			attr_dev(div0, "class", "wrapper svelte-1y4lrv1");
    			add_location(div0, file$2, 34, 1, 678);
    			attr_dev(div1, "class", "map-section svelte-1y4lrv1");
    			add_location(div1, file$2, 24, 0, 495);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function rollDice() {
    		if (!isRolled) setTimeout(() => $$invalidate(0, isRolled = false), 5100);
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-sxml5e");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-sxml5e");
